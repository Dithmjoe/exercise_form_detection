...
image_start = cv2.imread('/home/dith/server/pushup/human_Pushup_start.jpg')
image_start = cv2.cvtColor(image_start, cv2.COLOR_BGR2RGB)
image_mid = cv2.imread('/home/dith/server/pushup/human_Pushup_mid.jpg')
image_mid = cv2.cvtColor(image_mid, cv2.COLOR_BGR2RGB)
image_stop = cv2.imread('/home/dith/server/pushup/human_Pushup_start.jpg')
